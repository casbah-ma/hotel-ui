...
export const imageVariants = {
  ...
  extraSmall: tw`w-[7.4rem] h-[8.2rem] md:w-[8.2rem] md:h-[9.45rem] lg:w-[20.75rem] lg:h-[16.25rem]`,
  imageVertical: tw`w-[14.75rem] h-[16.4rem] md:w-[17.5rem] md:h-[19.4rem] lg:w-[33.75rem] lg:h-[37.5rem]`,
