...
export const StyledHeroContent = tw.div`text-white lg:text-black absolute pl-6 md:pl-12  z-20 lg:z-0 w-full lg:w-1/2 lg:static max-h-full 
flex flex-col items-start justify-start 
 md:mr-[4.188rem] md:ml-8`
...
export const StyledHeroChildren = tw.div`absolute bottom-[3.063rem] left-2 lg:left-8 z-50`
