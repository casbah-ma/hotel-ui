...
export { default as Bivouac } from './Bivouac'
export { default as Jacuzzi } from './Jacuzzi'
export { default as Desert } from './Desert'
export { default as FruitBasket } from './FruitBasket'
export { default as Coffee } from './Coffee'
export { default as Cooktop } from './Cooktop'
export { default as Toaster } from './Toaster'
export { default as Oven } from './Oven'
export { default as Household } from './Household'
export { default as kitchen } from './kitchen'
export { default as CableChannels } from './CableChannels'
export { default as BerberDinner } from './BerberDinner'
export { default as LocalMusic } from './LocalMusic'
...
export { default as Micros } from './Micros'
export { default as FlipChart } from './FlipChart'
export { default as NotFoundVector } from './NotFoundVector'
export { default as NotFound2 } from './NotFound2'
