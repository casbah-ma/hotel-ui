...
export const FooterDivider = tw.div`border-solid border w-[16rem] sm:w-[19.37rem] md:w-[85vw] lg:w-[90vw] mt-3 rounded-full`
export const FooterDividerText = tw.div`p-0 w-[16rem] sm:w-[19.37rem] md:w-[85vw] lg:w-[90vw] flex items-center justify-between text-xs -mt-5`
