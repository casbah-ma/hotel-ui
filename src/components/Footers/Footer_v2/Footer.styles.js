...
export const FooterLogo = tw.div`flex flex-col items-center justify-center w-[14rem] lg:mt-[-5.25rem]`
export const FooterText = tw.div`w-full lg:w-[20.25rem] md:pt-0 xs:pt-[4.188rem]`
