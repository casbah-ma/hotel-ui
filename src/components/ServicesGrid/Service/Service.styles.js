...
export const variants = {
  ...
  v2: tw`flex-row gap-7 lg:gap-11 justify-start py-7 pl-7 lg:py-9 lg:pl-9  
        w-[95%] md:w-[47%] lg:w-[34.4rem] rounded-2xl border border-[#DBDBDB]`,
  v3: tw`flex-row gap-4 lg:gap-6 w-full md:w-[45%] md:max-w-[47%] lg:w-96 lg:max-w-sm justify-start items-start`,
}
