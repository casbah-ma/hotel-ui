...
export const StyledHeader = styled.header(
  ({ isContact, theme, direction, withBorder }) => [
    direction === 'horizontal' &&
      tw`w-full flex flex-col gap-2 md:flex-row items-start justify-start`,
    direction === 'vertical' &&
      withBorder &&
...
export const DescriptionWrapper = styled.div(
  ({ direction, theme, withBorder }) => [
    ...
    direction === 'horizontal' &&
      tw`before:content-[""] before:absolute before:left-0 before:-top-2
        before:h-[1px] before:w-1/4 before:bg-black before:md:h-0 xs:before:left-2 sm:before:left-0`,
